...
function sek_maybe_display_feedback_notice() {
  ...
  if( 'settings_page_nb-options' !== $current_screen->base )
    ...
    <div class="notice notice-success is-dismissible" id="<?php echo esc_attr( $notice_id ); ?>">
      ...
      <p style="font-size:14px;font-weight:bold"><?php _e('Limited offer : get 25% off with code EOY2021 at checkout.' ); ?> <a class="sek-pro-link-in-dashboard" href="https://presscustomizr.com/nimble-builder-pro/" rel="noopener noreferrer" title="Go Pro" target="_blank">Go Pro</a> <span style="color: #f07829;" class="dashicons dashicons-external"></span></p>
