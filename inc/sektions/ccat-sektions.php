...
class Sek_Dyn_CSS_Builder {
    ...
    */
    ...
    public function __construct( $sek_model = array(), Sek_Stylesheet $stylesheet ) {
        ...
        $this->sek_dyn_css_builder_walker();
    }


    // loop on preset set of rules
    ...
    public function sek_dyn_css_builder_walker( $level = null, $stylesheet = null ) {
        ...
        foreach ( $collection as $level ) {
            ...
            if ( !empty( $level[ 'collection' ] ) ) {
                $this->sek_dyn_css_builder_walker( $level, $stylesheet );
            }
        }
    }
