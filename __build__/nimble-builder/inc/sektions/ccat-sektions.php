...
register_post_type( SEK_CPT , array(
    'labels' => array(
      'name'          => __( 'Sektion settings', 'nimble-builder' ),
      'singular_name' => __( 'Sektion settings', 'nimble-builder' ),
    ),
    'public'           => false,
    'hierarchical'     => false,
    'rewrite'          => false,
        ...
        array(
            ...
            'selectOptions' => array(
                  ...
                  'height-type' => array(
                      ...
                      'fit-to-screen' => __('Fit to screen', 'nimble-builder'),
            ...
            'i18n' => array(
                ...
                // Generated UI
                'Module Picker' => __('Module Picker', 'nimble-builder'),
                ...
                'Section Picker' => __('Section Picker', 'nimble-builder'),
                ...
                'Background and border settings for the' => __('Background and border settings for the', 'nimble-builder'),
          ...
          <?php
            $content_collection = array(
                array(
                  ...
                  'title' => __( 'Text Editor', 'nimble-builder' ),
                  'icon' => 'short_text'
                ),
                array(
                  'content-type' => 'module',
...
function sek_get_module_params_for_sek_module_picker_module() {
    return array(
        ...
        'name' => __('Module Picker', 'nimble-builder'),
...
function sek_get_module_params_for_sek_level_bg_border_module() {
    return array(
        ...
        'name' => __('Background and borders', 'nimble-builder'),
        // 'sanitize_callback' => 'function_prefix_to_be_replaced_sanitize_callback__czr_social_module',
        // 'validate_callback' => 'function_prefix_to_be_replaced_validate_callback__czr_social_module',
        'tmpl' => array(
            'item-inputs' => array(
                'tabs' => array(
                    array(
                        'title' => __('Background', 'nimble-builder'),
                        'inputs' => array(
                            'bg-color' => array(
                            ...
                            'bg-opacity-overlay' => array(
                                ...
                                'title'       => __('Opacity', 'nimble-builder'),
                    ...
                    array(
                        ...
                        'inputs' => array(
                            'border-width' => array(
                                'input_type'  => 'range_slider',
                                'title'       => __('Border width', 'nimble-builder'),
                                'min' => 0,
                                'max' => 100,
                                'unit' => 'px',
                                'default' => 1
    ...
    return array(
        ...
        'tmpl' => array(
            'item-inputs' => array(
                'height-type' => array(
                    'input_type'  => 'select',
                    'title'       => __('Height : fit to screen or custom', 'nimble-builder'),
                    'default'     => 'default'
                ),
                'custom-height' => array(
                    'input_type'  => 'range_slider',
    ...
    return array(
        ...
        'tmpl' => array(
            'item-inputs' => array(
                'tabs' => array(
                    array(
                        'title' => __('Desktop', 'nimble-builder'),
                        'attributes' => 'data-sek-device="desktop"',
                        'inputs' => array(
                            'desktop_pad_marg' => array(
                                'input_type'  => 'spacing',
                                'title'       => __('Set padding and margin for desktops', 'nimble-builder'),
                                'title_width' => 'width-100',
                                'width-100'   => true,
                                'default'     => array()
                            ),
                            'desktop_unit' =>  array(
                                'input_type'  => 'select',
                                'title'       => __('Unit', 'nimble-builder'),
                                'default'     => 'px'
                            )
                        )
                    ),
                    array(
                        'title' => __('Tablet', 'nimble-builder'),
                        'attributes' => 'data-sek-device="tablet"',
                        'inputs' => array(
                            'tablet_pad_marg' => array(
                                'input_type'  => 'spacing',
                                'title'       => __('Set padding and margin for tablet devices', 'nimble-builder'),
                                'title_width' => 'width-100',
                                'width-100'   => true,
                                'default'     => array()
                            ),
                    ...
                    array(
                        'title' => __('Mobile', 'nimble-builder'),
                        'attributes' => 'data-sek-device="mobile"',
                        'inputs' => array(
                            'mobile_pad_marg' => array(
                                'input_type'  => 'spacing',
                                'title'       => __('Set padding and margin for mobile devices', 'nimble-builder'),
                                'title_width' => 'width-100',
                                'width-100'   => true,
                                'default'     => array()
                            ),
                    ...
                    array(
                        ...
                        'inputs' => array(
                            ...
                            'font_size_css'       => array(
                                ...
                                'title'       => __('Font size in pixels', 'nimble-builder'),
                                'default'     => '16px',
                                'refresh-markup' => false,
                                'refresh-stylesheet' => true
                            ),//16,//"14px",
                            'line_height_css'     => array(
                                ...
                                'title'       => __('Line height in pixels', 'nimble-builder'),
                                'default'     => '24px',
                                'refresh-markup' => false,
                                'refresh-stylesheet' => true
                            ),//24,//"20px",
                    ...
                    <div class="sek-dyn-ui-inner <?php echo $icon_left_side_class; ?>">
                      <div class="sek-dyn-ui-icons">
                        ...
                        <# if ( data.can_have_more_columns ) { #>
                          <i data-sek-click-on="add-column" class="material-icons sek-click-on" title="<?php _e( 'Add Column', 'nimble-builder' ); ?>">add</i>
                        <# } #>
                  ...
                  <div class="sek-dyn-ui-wrapper sek-column-dyn-ui">
                    <div class="sek-dyn-ui-inner <?php echo $icon_left_side_class; ?>">
                      <div class="sek-dyn-ui-icons">
                        ...
                        <i data-sek-click-on="pick-module" class="material-icons sek-click-on" title="<?php _e( 'Add Module', 'nimble-builder' ); ?>">add</i>
                        ...
                        <# if ( ! data.parent_is_last_allowed_nested ) { #>
                          <i data-sek-click-on="add-section" class="fas far fa-plus-square sek-click-on" title="<?php _e( 'Add a nested section', 'nimble-builder' ); ?>"></i>
                        <# } #>
    ...
    class SEK_Front_Render extends SEK_Front_Assets {
                              ...
                              if ( skp_is_customizing() && empty( $collection ) ) {
                                  ...
                                  <div class="sek-no-modules-column">
                                    <div class="sek-module-drop-zone-for-first-module sek-content-module-drop-zone sek-drop-zone">
                                      <i data-sek-click-on="pick-module" class="material-icons sek-click-on" title="<?php _e('Add a module here', 'nimble-builder' ); ?>">add</i>
                                    </div>
                                  </div>
                                  <?php
                              } else {
        ...
        function sek_get_input_placeholder_content( $input_type = '', $input_id = '' ) {
            ...
            switch( $input_type ) {
                ...
                case 'text' :
                  $ph = skp_is_customizing() ? '<div style="padding:10px;border: 1px dotted;background:#eee">' . __('Click to edit', 'nimble-builder') .'</div>' : '<i class="material-icons">short_text</i>';
                break;
                case 'upload' :
