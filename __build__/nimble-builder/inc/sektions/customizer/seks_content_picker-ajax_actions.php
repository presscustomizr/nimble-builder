...
*
*/
if ( ! class_exists( 'SEK_customize_ajax_content_picker_actions' ) ) :
  class SEK_customize_ajax_content_picker_actions {
      static $instance;
      ...
      function sek_add_custom_item_to_ajax_results( $items, $page, $context ) {
      ...
      public function ajax_search_available_items() {
            ...
            if ( empty( $items ) ) {
                wp_send_json_error( array( 'message' => __( 'No results found.', 'nimble-builder') ) );
            } else {
                wp_send_json_success( array(
