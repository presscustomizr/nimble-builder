module.exports = {
  ...
  czr_sektions_php : {
    src: [
      ...
      '<%= paths.sektions %>_dev_php/module_registration/ui/_2_local/4_1_4_sek_register_local_performances.php',
      ...
      '<%= paths.sektions %>_dev_php/module_registration/ui/_3_global/4_1_4_sek_register_global_performances.php',
