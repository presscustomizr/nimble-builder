module.exports = {
  ...
  czr_sektions_customizer_control_js : {
    src: [
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/modules/ui/_2_local/_9_1_5_UI_local_header.js',
      '<%= paths.czr_assets %>sek/js/_dev_control/modules/ui/_2_local/_9_1_6_UI_local_footer.js',
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/modules/ui/_3_global/_9_1_4_UI_global_header.js',
      '<%= paths.czr_assets %>sek/js/_dev_control/modules/ui/_3_global/_9_1_5_UI_global_footer.js',
  ...
  czr_sektions_front_php : {
    src: [
      ...
      '<%= paths.sektions %>_front_dev_php/module_registration/ui/_2_local/4_1_5_sek_register_local_header.php',
      '<%= paths.sektions %>_front_dev_php/module_registration/ui/_2_local/4_1_6_sek_register_local_footer.php',
      ...
      '<%= paths.sektions %>_front_dev_php/module_registration/ui/_3_global/4_1_5_sek_register_global_header.php',
      '<%= paths.sektions %>_front_dev_php/module_registration/ui/_3_global/4_1_6_sek_register_global_footer.php',
