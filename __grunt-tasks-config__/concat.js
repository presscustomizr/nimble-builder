module.exports = {
  ...
  czr_sektions_php : {
    src: [
      ...
      '<%= paths.sektions %>_dev_php/module_registration/4_0_3_sek_register_section_layout.php',
      '<%= paths.sektions %>_dev_php/module_registration/4_0_3_sek_register_height.php',
