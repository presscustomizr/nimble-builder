module.exports = {
  ...
  czr_sektions_php : {
    src: [
      ...
      '<%= paths.sektions %>_front_dev_php/1_0_0_sektions_customizer_assets.php',
      '<%= paths.sektions %>_front_dev_php/2_0_0_sektions_customizer_dynamic_registration.php',

      // INPUT TEMPLATES
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_1_sek_input_tmpl_base_filter.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_2_sek_input_tmpl_module_sektion_picker.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_3_sek_input_tmpl_spacing.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_4_sek_input_tmpl_bg_position.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_5_sek_input_tmpl_horizontal_alignment.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_6_sek_input_tmpl_vertical_alignment.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_71_sek_input_tmpl_fa_icon_picker.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_7_sek_input_tmpl_font_picker.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_8_sek_input_tmpl_font_size_line_height.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_0_9_sek_input_tmpl_code_editor.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_1_sek_input_tmpl_range_simple.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_2_sek_input_tmpl_range_with_unit_picker.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_3_sek_input_tmpl_range_with_unit_picker_device_switcher.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_4_sek_input_tmpl_borders.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_5_sek_input_tmpl_border_radius.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_6_sek_input_tmpl_buttons_choice.php',
      '<%= paths.sektions %>_front_dev_php/input_tmpl/3_1_7_sek_input_tmpl_reset_button.php',
  ...
  czr_sektions_customizer_control_js : {
    src: [
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/_1_1_sektions_topbar.js',
