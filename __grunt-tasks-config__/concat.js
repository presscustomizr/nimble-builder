module.exports = {
  ...
  czr_sektions_customizer_control_js : {
    src: [
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/_1_1_5_3_sektions_template_inject_ui.js',
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/_1_7_2_sektions_update_API_setting_CONTENT_IN_SECTIONS.js',
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/_1_7_6_sektions_update_API_setting_TMPL_INJECT.js',
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/_8_0_sektions_file_import_export.js',
      ...
      '<%= paths.czr_assets %>sek/js/_dev_control/modules/front/_9_5_7_FRONT_gallery.js'
  ...
  czr_sektions_constants_helper_functions_php : {
    src: [
      ...
      '<%= paths.sektions %>_front_dev_php/_constants_and_helper_functions/0_9_0_0_sektions_functions_seks_post_set_get.php',
      '<%= paths.sektions %>_front_dev_php/_constants_and_helper_functions/0_9_0_1_sektions_functions_site_templates.php',
  ...
  czr_sektions_front_modules_php : {
    src: [
      ...
      '<%= paths.sektions %>_front_dev_php/module_registration/front/4_3_4_sek_register_gallery.php'
