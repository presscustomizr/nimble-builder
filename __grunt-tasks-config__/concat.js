module.exports = {
  ...
  sektions_front_js : {
    src: [
      ...
      // '<%= paths.front_assets %>js/_dev_front_concat/0_0_3_front_scroll_handler_for_assets.js',
      // '<%= paths.front_assets %>js/_dev_front_concat/0_0_4_front_schedule_assets_loading_on_scroll.js',
      // '<%= paths.front_assets %>js/_dev_front_concat/0_0_5_front_smartload_plugin.js',
      // '<%= paths.front_assets %>js/_dev_front_concat/0_0_6_front_parallax_plugin.js',
      // '<%= paths.front_assets %>js/_dev_front_concat/0_0_7_front_accordion_module.js',
