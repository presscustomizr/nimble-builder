...
( function ( api, $, _ ) {
      ...
      var QuoteModuleConstructor = {
              initialize: function( id, options ) {
                      ...
                      //EXTEND THE DEFAULT CONSTRUCTORS FOR INPUT
                      module.inputConstructor = api.CZRInput.extend( module.CZRQuoteInputMths || {} );

                      //EXTEND THE DEFAULT CONSTRUCTORS FOR MONOMODEL
                      module.itemConstructor = api.CZRItem.extend( module.CZRQuoteItemConstructor || {} );
      ...
      $.extend( api.czrModuleMap, {
            czr_quote_module : {
                  mthds : QuoteModuleConstructor,
                  crud : false,
                  name : api.czr_sektions.getRegisteredModuleProperty( 'czr_quote_module', 'name' ),
                  has_mod_opt : false,
                  ready_on_section_expanded : true,
                  defaultItemModel : api.czr_sektions.getDefaultItemModelFromRegisteredModuleData( 'czr_quote_module' )
            }
      });
})( wp.customize , jQuery, _ );//global sektionsLocalizedData, serverControlParams
//extends api.CZRDynModule
...
( function ( api, $, _ ) {
      ...
      $.extend( api.czrModuleMap, {
            czr_simple_form_design_module: {
                  mthds : Constructor,
                  crud : false,
                  name : api.czr_sektions.getRegisteredModuleProperty( 'czr_simple_form_design_module', 'name' ),
                  has_mod_opt : false,
                  ready_on_section_expanded : true,
                  defaultItemModel : api.czr_sektions.getDefaultItemModelFromRegisteredModuleData( 'czr_simple_form_design_module' )
            }
      });
})( wp.customize , jQuery, _ );